...
urlpatterns = [
    ...
    path('avisos-professores/relatorio/', views.relatorio_avisos_professores, name='relatorio_avisos_professores'),
    ...
    path('faltas-alunos/conferencia/', views.conferencia_faltas_alunos, name='conferencia_faltas_alunos'),
    path('faltas-alunos/conferencia/imprimir/', views.imprimir_conferencia_faltas_alunos, name='imprimir_conferencia_faltas_alunos'),
    path('faltas-alunos/justificar/', views.justificar_faltas_alunos, name='justificar_faltas_alunos'),
    ...
    path('ocorrencias/conferencia/', views.conferencia_ocorrencias, name='conferencia_ocorrencias'),
    path('ocorrencias/conferencia/imprimir/', views.imprimir_conferencia_ocorrencias, name='imprimir_conferencia_ocorrencias'),
    ...
    path('historico-acessos/', views.historico_acessos, name='historico_acessos'),
